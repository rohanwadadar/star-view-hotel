...
?>
  ...
  <script type="text/javascript">
        function showLoginMessage() {
            alert("Please log in to get ultimate access");
            window.location.href = "login.php";
        }

        // Set an interval to show the message every 2 minutes (120,000 milliseconds)
        setInterval(showLoginMessage, 120,000 milliseconds);
    </script>
...
<script>
        window.addEventListener('scroll', function() {
            const navbar = document.querySelector('.navbar');
            let scrollPosition = window.pageYOffset;
            navbar.style.transform = 'translateY(' + scrollPosition * 1.0 + 'px)';
        });
    </script>  
...
<section id="welcome-section" class="welcome-section">
    <div class="container1">
      ...
      -->
        ...
        <a href="booking1.php" class="button-container">Check For Rooms</a>
    </div>
</section>
...
<section id="latest-food" class="latest-food">
    ...
    <div>
        ...
        <h1 class="text-center mb-4">Explore our captivating gallery and immerse yourself in the beauty of STAR-VIEW  and its surroundings.</h1>
    </div>
</section>
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>STAR-VIEW - Luxurious Stay in Darjeeling</title>
  ...
  <div class="container">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var startTime = 12; // Change this to the desired start time
...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <title>Star-view Hotel Darjeeling Review</title>
