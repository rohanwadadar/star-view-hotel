...
<div class="container">
    ...
    <form action="book_room.php" method="post"> <!-- Updated action to book_room.php -->
    <?php
    ...
    if(isset($_POST['selected_room'], $_POST['start_date'], $_POST['end_date'])) {
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<p>Room Price: Rupees $room_price per day</p>";
    ...
    ?>
  <button type="submit" formaction="addtocart.php" class="btn btn-success">Add to Cart</button>   
</form>
